...
class CardDAVBirthdayCalendarConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    ) -> CardDAVBirthdayCalendarOptionsFlow:
        return CardDAVBirthdayCalendarOptionsFlow(config_entry)


class CardDAVBirthdayCalendarOptionsFlow(config_entries.OptionsFlow):
    """Handle options."""
