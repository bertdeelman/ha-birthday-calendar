"""Calendar platform for Birthday Calendar integration."""
...
async def async_setup_entry(
    ...
    """Set up the Birthday Calendar entity from a config entry."""
...
class BirthdayCalendarEntity(CoordinatorEntity[BirthdayCalendarCoordinator], CalendarEntity):
    ...
    def __init__(
        ...
        self._entry = entry
        self._attr_unique_id = f"{entry.entry_id}_birthday_calendar"
